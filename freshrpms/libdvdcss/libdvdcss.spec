...
%changelog
* Wed Jul 20 2011 Matthias Saou <matthias@saou.eu> 1.2.10-3
- Rebuild for Fedora 14+.

* Fri Jun 19 2009 Matthias Saou <matthias@saou.eu> 1.2.10-2
- Update URL and rebuild for Fedora 11.

* Mon Sep  1 2008 Matthias Saou <matthias@saou.eu> 1.2.10-1
- Update to 1.2.10.
- Include new pkgconfig file, and add requirement in the devel package.

* Fri Mar 17 2006 Matthias Saou <matthias@saou.eu> 1.2.9-2
- Disable/remove static library, nothing seems to require it.

* Mon Jul 11 2005 Matthias Saou <matthias@saou.eu> 1.2.9-1
- Update to 1.2.9.
- Include doxygen generated html doc. Don't include refman, it's too big.

* Wed May 19 2004 Matthias Saou <matthias@saou.eu> 1.2.8-4
- Rebuild for Fedora Core 2.

* Tue Feb 24 2004 Matthias Saou <matthias@saou.eu> 1.2.8-3
- Updated the URL and Source tags to point to the new locations.

* Thu Nov  6 2003 Matthias Saou <matthias@saou.eu> 1.2.8-2
- Rebuild for Fedora Core 1.

* Sun Aug  3 2003 Matthias Saou <matthias@saou.eu>
- Update to 1.2.8.

* Wed Jun 25 2003 Matthias Saou <matthias@saou.eu>
- Update to 1.2.7.

* Mon Mar 31 2003 Matthias Saou <matthias@saou.eu>
- Rebuilt for Red Hat Linux 9.
- Exclude .la file.

* Tue Mar 11 2003 Matthias Saou <matthias@saou.eu>
- Update to 1.2.6.

* Mon Feb  3 2003 Matthias Saou <matthias@saou.eu>
- Update to 1.2.5.

* Fri Nov 15 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.2.4.

* Mon Oct 21 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.2.3.

* Thu Sep 26 2002 Matthias Saou <matthias@saou.eu>
- Rebuilt for Red Hat Linux 8.0.

* Mon Aug 12 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.2.2.

* Mon Jun  3 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.2.1.

* Fri May 24 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.2.0.

* Thu May  2 2002 Matthias Saou <matthias@saou.eu>
- Rebuilt against Red Hat Linux 7.3.
- Added the %%{?_smp_mflags} expansion.

* Mon Apr  8 2002 Matthias Saou <matthias@saou.eu>
- Update to 1.1.1.

* Sun Nov  4 2001 Matthias Saou <matthias@saou.eu>
- Changed to the Ogle patched version of the lib.

* Mon Oct 22 2001 Matthias Saou <matthias@saou.eu>
- Initial RPM release.
