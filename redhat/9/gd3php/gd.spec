...
# See https://github.com/libgd/libgd/issues/678 - heif segfault
%bcond_with         heif
...
%if 0%{?rhel} == 10
%ifarch x86_64
XFAIL_TESTS="gdimagegrayscale/basic gdimagecopyresampled/bug00201"
%endif
%endif
export XFAIL_TESTS
...
%changelog
* Wed Aug 27 2025 Remi Collet <remi@remirepo.net> - 2.3.3-10
- EL-10 rebuild
