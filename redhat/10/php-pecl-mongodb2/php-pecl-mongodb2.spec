# remirepo spec file for php-pecl-mongodb2
#
...
%{?scl:%scl_package php-pecl-mongodb2}
...
# previously was the pure-PHP library, now only the extension
...
- open https://github.com/mongodb/mongo-php-driver/issues/1886
  version 2.1.3 still uses libmongoc 1.30.5

* Thu Oct  2 2025 Remi Collet <remi@remirepo.net> - 2.1.2-1
- update to 2.1.2
- drop patch merged upstream

* Thu Sep 25 2025 Remi Collet <remi@remirepo.net> - 2.1.1-4
