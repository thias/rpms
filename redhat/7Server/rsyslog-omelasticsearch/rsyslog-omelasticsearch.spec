...
%define rsyslog_docdir %{_docdir}/rsyslog-%{version}
%if 0%{?rhel} >= 7
...
Name: rsyslog-omelasticsearch
Version: 7.4.7
Release: 12%{?dist}
Summary: ElasticSearch output module for rsyslog
Requires: rsyslog = %{version}
Conflicts: rsyslog-elasticsearch
BuildRequires: libcurl-devel
# https://github.com/rsyslog/rsyslog/commit/3efed52b305e54a1aa3d93e4d314168078ec383f
Patch100: rsyslog-7.4.7-omelasticsearch.patch
...
# REMOVE ALL BUT THE SINGLE MODULE WE WANT
find %{buildroot} -type f -a ! -name omelasticsearch.so -delete
...
%changelog
* Thu Dec 17 2015 Matthias Saou <matthias@saou.eu> 7.4.7-12
- Patch omelasticsearch, see https://github.com/rsyslog/rsyslog/issues/104
- Build only patched module with different name and conflicting with original.
