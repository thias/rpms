...
/usr/bin/find %{_builddir}/%{name} -name "*gz" -exec tar -xzvf {} \;
# Cleanup / Fixup
/usr/bin/find . -name ".xvpics" -o -name "CVS" -o -name "*~" | xargs rm -rf
...
%changelog
* Thu Sep 29 2011 Matthias Saou <matthias@saou.eu> 2.1.8-5
- Bring back from the dead for my new RHEL6 workstation.
